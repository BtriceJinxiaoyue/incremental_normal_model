...
x_initial;
v_initial=[10;-5;-4;9;-8;0;4;-9;1;-4;15;10;2;2];
...
Deltay=R1(2,:);
uarray=zeros(14,1);
phiuarray=zeros(14,1);
%************** 二阶初始化 **************************%
x_y0=[-72 -10 -70  -8   -68 -10  -70  -12]; v_y0=[-1.48963896022215	3.35168766049983	-2.97927792044430	0	1.48963896022215	-3.35168766049983	0.372409740055537	-1.48963896022215];
x_y02=[-32 -30 -30  -28   -28 -30  -30  -32]; v_y2=[1.98118402542975	-0.990592012714873	-1.58494722034380	0	0.792473610171899	-1.78306562288677	0.198118402542975	-0.792473610171899];
x_y03=[-32  10 -30   12   -28  10  -30    8]; v_y3=[4.89687638016024	-2.44843819008012	-1.95875055206410	4.40718874214422	1.95875055206410	-4.40718874214422	0.489687638016024	-1.95875055206410];
x_y04=[-62  10 -60   12   -58  10  -60    8]; v_y4=[3.39493413390758	-1.69746706695379	-1.35797365356303	3.05544072051682	-2.71594730712606	0	0.339493413390758	-1.35797365356303];
x_y05=[-62  -30 -60  -28  -58  -30  -60  -32]; v_y5=[9.51630464777727	-4.75815232388864	-3.80652185911091	8.56467418299954	-7.61304371822182	0	3.80652185911091	-8.56467418299954];
x_y06=[-22  -10 -20  -8   -18  -10  -20  -12]; v_y6=[-3.68132815934626	8.28298835852907	-7.36265631869251	0	3.68132815934626	-8.28298835852907	0.920332039836564	-3.68132815934626];
...
Xarray_y6=[];
%初始化
x_y=[x(1:2);x_y0';x(15:16);v_y0'];
Xarray_y=x_y;
x_y2=[x(3:4);x_y02';x(17:18);v_y2'];
Xarray_y2=x_y2;
x_y3=[x(5:6);x_y03';x(19:20);v_y3'];
Xarray_y3=x_y3;
x_y4=[x(7:8);x_y04';x(21:22);v_y4'];
Xarray_y4=x_y4;
x_y5=[x(9:10);x_y05';x(23:24);v_y5'];
Xarray_y5=x_y5;
x_y6=[x(11:12);x_y06';x(25:26);v_y6'];
Xarray_y6=x_y6;
%************** 神经网络初始化 *********************%
ell = 52;%神经元数目
...
%        end
       [Delta_State,u,phiu,varepsilon1,varepsilon2,Delta_W,bar_varepsilon1,bar_varepsilon2,dot_bar_varepsilon1,dot_bar_varepsilon2]=slidingcontrol3(tau,x,L,B,fkx,fky,A_N,dotH,W,bar_varepsilon1,bar_varepsilon2,dot_bar_varepsilon1,dot_bar_varepsilon2,lbtf,dt1);
       x=x+Delta_State*dt1;
       W = W + Delta_W * dt1;
       Xarray=[Xarray x];
       uarray=[uarray u];
